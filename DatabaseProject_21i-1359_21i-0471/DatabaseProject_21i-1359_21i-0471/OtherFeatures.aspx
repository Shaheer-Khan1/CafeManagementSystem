<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherFeatures.aspx.cs" Inherits="DatabaseProject_21i_1359_21i_0471.OtherFeatures" %>
...
<body>
    <form id="form1" runat="server">
        <div class="gridview-container">
            ...
            <asp:Button ID="Return" runat="server" OnClick="Return_Click" Text="Go Back" CssClass="button-style" />
        </div>
    </form>
</body>
</html>
